...
export const PERSONAL = {
  ...
  web3formsKey: 'eea89dd6-fef5-41bc-b557-f330231c3b95',
};

export const STATS = [
  { value: 2600, suffix: '+', label: 'Problems Solved' },
...
export const NARRATIVE = {
  ...
  competitiveProgramming: `With over 2,600 algorithmic challenges solved globally — spanning dynamic programming, graph theory, number theory, and advanced data structures — I've cultivated a thinking discipline that translates directly into how I design AI architectures. Every model I build, every system I architect, carries the rigor and optimization mindset of competitive programming.`,
};
...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      'A comprehensive data visualization dashboard analyzing UK road accident metrics. Features interactive KPIs, year-over-year casualty trends, geospatial mapping of incidents, and detailed breakdowns by vehicle type, road type, and environmental conditions.',
    tech: ['Power BI', 'Data Visualization', 'DAX', 'Power Query', 'Geospatial Analysis'],
    metrics: ['195.7K Casualties', 'YoY Trend Tracking', 'Interactive KPIs'],
    image: '/assets/road-accident-dashboard.png',
    featured: true,
  },
...
export const CERTIFICATIONS = [
  ...
  { name: 'AI Tools Workshop', issuer: 'Be10x', date: '2026', link: 'https://lh3.googleusercontent.com/d/1BkmOTlrx33t56ol4h3T8ywC7UjKAyw92' },
  { name: 'Machine Learning with Python', issuer: 'freeCodeCamp', date: '2026', link: 'https://lh3.googleusercontent.com/d/1bEblOx_m_X1GM0MJ2RYfDF85hG74ixLU' },
